...
static void initialize_ImageDecoder() {
    ...
    // load methods
    {
        ...
        methods_ImageDecoder[3] = ::ndk::JniWrapper::loadMethod(class_ImageDecoder, "decodeFromStream", "(Ljava/io/InputStream;)Lcom/eaglesakura/jc/jni/image/ImageDecoder;", true);
        ...
        methods_ImageDecoder[6] = ::ndk::JniWrapper::loadMethod(class_ImageDecoder, "decodeFromBitmap", "(Landroid/graphics/Bitmap;Z)Lcom/eaglesakura/jc/jni/image/ImageDecoder;", true);
